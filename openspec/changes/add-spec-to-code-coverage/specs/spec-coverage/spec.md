...
## Purpose
Define how Krokis derives spec-to-code coverage by scanning local OpenSpec specs and the workspace tree, and how it presents the result on the dashboard.
