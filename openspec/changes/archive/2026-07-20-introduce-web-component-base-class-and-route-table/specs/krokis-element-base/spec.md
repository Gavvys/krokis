...
## Purpose
Define the shared base class for Krokis Web Components so each component owns only its render logic and not the boilerplate that every component repeats.
