...
## Purpose
Define how `krokis init` becomes idempotent and post-scaffolding doctor invocation becomes automatic so a single command covers both new and existing projects.
