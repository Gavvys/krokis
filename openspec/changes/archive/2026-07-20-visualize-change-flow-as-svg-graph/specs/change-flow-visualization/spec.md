...
## Purpose
Define how the dashboard renders an SVG change-flow graph for an active OpenSpec change, so users see the proposal-to-implementation pipeline at a glance instead of reading flat markdown.
