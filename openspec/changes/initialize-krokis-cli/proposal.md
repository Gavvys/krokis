...
- Support `krokis skill` to manage agent instructions and hooks under `.krokis/skills/`.
...
- `agent-skills`: Provides a discoverable set of instructions and execution scripts under `.krokis/skills/` for AI agents to run hooks.
